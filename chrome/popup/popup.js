    ...
    render() {
        return html`
            <div style="display: flex; align-items: center; margin: 0;">
                <img src="icon.png" alt="icon" style="width: 30px; height: 30px;">
                <h1 style="margin-left: 10px; font-size: 16px;">${brw.i18n.getMessage("extName")}</h1>
            </div>
            <hr>
...
export class RedoButton extends LitElement {
    ...
    render() {
        ...
        <div style=" margin-top: 20px;">
            <button style="background-color: #000; color: #fff; border: 1px solid #000; padding: 10px 20px; font-size: 16px; border-radius: 5px; cursor: pointer; transition-duration: 0.4s;"
                @click=${this.redoPatternCheck}>
                ${brw.i18n.getMessage("buttonRedoPatternCheck")}
            </button>
        </div>
    `;
    }
...
export class ShowPatternButtons extends LitElement {
    ...
    render() {
        ...
        <div>
            ...
            <span class="button" @click=${this.showNextPattern}>
             >
            </span>
...
export class PopupFooter extends LitElement {
    ...
    render() {
        return html`
        <div>
            ${brw.i18n.getMessage("textMoreInformation")}: <a href="https://lightheads.co/dark-patterns" target="_blank">lightheads.co</a>.
        </div>
      `;
    }
}
